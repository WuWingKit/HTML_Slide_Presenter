...
你只需用 `<div class="slide">` 标记每一页，剩下的交给放映器。内置 6 套精美模板，不写样式也能一键美化。

## 🎯 核心特性

- **🎨 6 套预设模板** — 简约白底 / 深色科技 / 渐变多彩 / 商务蓝 / 水墨风 / Nord 冷调，下拉菜单秒切
- **📐 文字自适应** — 使用 clamp() 单位，全屏/窗口化任意缩放，文字始终清晰
- **📐 幻灯片居中** — 16:9 比例自动居中，黑边填充，专业演示效果
...
> **v1.0.1 更新:** 幻灯片自动居中显示，新增 Nord 冷调模板，底部进度条，自定义样式自动检测。
...
不写样式直接在播放器里选模板即可。自己写了样式选"自定义样式"保留原样。
